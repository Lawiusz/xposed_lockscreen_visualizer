                        ...
                        protected void afterHookedMethod(XC_MethodHook.MethodHookParam param)
                            ...
                            if (pkgName.contentEquals(MainXposedMod.SYSTEMUI_PACKAGE)) {
                                ...
                                if (!grantedPerms.contains(PERM_MOD_AUDIO)) {
                                    final Object pModifyAudio = XposedHelpers
                                    ...
                                    int[] bpGids = (int[]) XposedHelpers
                                            .getObjectField(pModifyAudio, "gids");
                                ...
                                if (!grantedPerms.contains(PERM_RECORD_AUDIO)) {
                                    final Object pRecordAudio = XposedHelpers
                                            .callMethod(permissions, "get",
                                            PERM_RECORD_AUDIO);
                                    ...
                                    int[] gpGids = (int[]) XposedHelpers
                                            .getObjectField(extras, "gids");
                                    int[] bpGids = (int[]) XposedHelpers
                                            .getObjectField(pRecordAudio, "gids");
                                    //noinspection UnusedAssignment
                                    gpGids = (int[]) XposedHelpers
                                            .callStaticMethod(param.thisObject.getClass(),
                                            "appendInts", gpGids, bpGids);
                    ...
                    CLASS_PACKAGE_PARSER_PACKAGE, boolean.class, String.class, new XC_MethodHook() {
                        ...
                        protected void afterHookedMethod(XC_MethodHook.MethodHookParam param)
                            ...
                            if (pkgName.contentEquals(MainXposedMod.SYSTEMUI_PACKAGE)) {
                                ...
                                if (!grantedPerms.contains(PERM_MOD_AUDIO)) {
                                    final Object pModifyAudio = XposedHelpers
                                            .callMethod(permissions, "get", PERM_MOD_AUDIO);
                                ...
                                if (!grantedPerms.contains(PERM_RECORD_AUDIO)) {
                                    final Object pRecordAudio = XposedHelpers
                                            .callMethod(permissions, "get", PERM_RECORD_AUDIO);
                                    XposedHelpers.callMethod(ps, "grantInstallPermission",
                                            pRecordAudio);
                                }
